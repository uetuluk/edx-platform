...
# Disable lookup of Enterprise consent_required_course due to ENT-727
    ...
    edx_show_cta_dialogue = request.COOKIES.get('edx-show-cta-dialogue', None)
    ...
    context = {
        ...
        'user': user,
        'edx_show_cta_dialogue': edx_show_cta_dialogue,
    ...
    if edx_show_cta_dialogue:
        response.delete_cookie('edx-show-cta-dialogue')
